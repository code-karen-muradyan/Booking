...
namespace Booking.Calendar.API.Infrastructure
{
    public class CalendarContext: DbContext
    {
        ...
        public DbSet<Booking.Calendar.API.Models.Calendar> Calendars { get; set; }
        ...
        //Task<bool> IIdempotencyRepository.RequestExists(Guid id)
        //{
        //    return this.ClientRequests.AnyAsync(x => x.Id == id);
        //}

        //Task IIdempotencyRepository.AddAsync(ClientRequest request)
        //{
        //    this.Add(request);
        //    return Task.CompletedTask;
        //}

        //Task<ClientRequest> IIdempotencyRepository.GetClientRequestAsync(Guid id)
        //{
        //    return this.ClientRequests.AsNoTracking().FirstOrDefaultAsync(x => x.Id == id);
        //}

        //Task IIdempotencyRepository.UpdateClientRequestAsync(ClientRequest req)
        //{
        //    var trackedEntry = this.ChangeTracker.Entries<ClientRequest>().FirstOrDefault(x => x.Entity.Id == req.Id);
        //    if (trackedEntry != null)
        //        trackedEntry.CurrentValues.SetValues(req);
        //    else
        //        this.Update(req);
